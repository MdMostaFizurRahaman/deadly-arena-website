    ...
    <div class="row row-xs">
      <div class="col-sm-6 col-lg-3">
        <div class="card card-status">
          <div class="media">
            <i class="icon fa fa-users tx-primary"></i>
            <div class="media-body">
              <h1>{{number_format(DB::table('players')->count())}}</h1>
              <p>Total Players</p>
            </div><!-- media-body -->
          </div><!-- media -->
        </div><!-- card -->
      ...
      <div class="col-sm-6 col-lg-3 mg-t-10 mg-sm-t-0">
        <div class="card card-status">
          <div class="media">
            <i class="icon fa fa-trophy tx-teal"></i>
            <div class="media-body">
              <h1>17,583</h1>
              <p>Total Playing</p>
            </div><!-- media-body -->
      ...
      <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
        <div class="card card-status">
          <div class="media">
            <i class="icon fa fa-sign-in tx-purple"></i>
            <div class="media-body">
              <h1>61,119</h1>
              <p>Total Logged In</p>
            </div><!-- media-body -->
      ...
      <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
        <div class="card card-status">
          <div class="media">
            <i class="icon fa fa-money tx-pink"></i>
            <div class="media-body">
              <h1>{{number_format(DB::table('asset_player')->sum('amount'))}}</h1>
              <p>Total Purchase</p>
            </div><!-- media-body -->
          </div><!-- media -->
        </div><!-- card -->
...
@section('scripts')
<script src="{{asset('backend')}}/lib/chartist/js/chartist.js"></script>
<script src="{{asset('backend')}}/lib/d3/js/d3.js"></script>
<script src="{{asset('backend')}}/lib/rickshaw/js/rickshaw.min.js"></script>
<script src="{{asset('backend')}}/lib/jquery.sparkline.bower/js/jquery.sparkline.min.js"></script>
