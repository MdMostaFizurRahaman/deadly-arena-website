            ...
            <div class="col-md-12 isotope">
                ...
                <ul class="pagination">
                    ...
                    @foreach ($categories as $category)
                        <li class="{{Request::route('id') == $category->id ? 'active': ''}}"><a href="{{route('store.category', $category->id)}}">{{Str::title($category->name)}}</a></li>
                    @endforeach 
                </ul>
                <!-- /Sort Categories -->
                ...
                <div class="isotope-list row vertical-gutter" style="position: relative; height: 1638.67px;">
                    @foreach ($assets as $asset)
                        ...
                        <div class="item col-lg-4 col-md-6 col-xs-12" data-filters="popular" style="position: absolute; left: 0px; top: 1310.94px;">
